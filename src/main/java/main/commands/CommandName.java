...
public class CommandName {
    ...
    public static final String COMMAND__SHOW_UPDATE_DISH = "showUpdateDish";
    public static final String COMMAND__SHOW_NEW_DISH = "showNewDish";
    public static final String COMMAND__NEW_DISH = "newDish";
    public static final String COMMAND__UPDATE_DISH = "updateDish";
    public static final String COMMAND__DELETE_DISH = "deleteDish";
    ...
    public static final String COMMAND__SHOW_SEND_APPLICATION = "showSendApplication";
    public static final String COMMAND__SEND_APPLICATION = "sendApplication";
    public static final String COMMAND__SHOW_APPLICATIONS = "showApplications";
    public static final String COMMAND__SHOW_APPLICATION_PROCESS = "showApplicationProcess";
    public static final String COMMAND__APPLICATION_PROCESS = "applicationProcess";
